...
def add_model_options(parser):
    ...
    group.add_argument("--use_casim", action='store_true',
                       help="Use CASIM-MDM")
    group.add_argument("--clip_final_proj", action='store_true', help='Use the final projected clip token embeddings.')
    group.add_argument("--use_bert", action='store_true',
                       help="Use Bert with CASIM-MDM which has advanced BERT embedding.")
    group.add_argument("--save_attn_value", action='store_true',)
...
def add_evaluation_options(parser):
    ...
    group.add_argument("--model_path", required=True, type=str,
                       help="Path to model####.pt file to be sampled.")
    group.add_argument("--eval_mode", default='no_sample_limit', choices=['wo_mm', 'mm_short', 'debug', 'full', 'no_sample_limit'], type=str,
                       help="wo_mm (t2m only) - 20 repetitions without multi-modality metric; "
                            ...
                            "no_sample_limit - will sample all available samples.")
    group.add_argument("--guidance_param", default=2.5, type=float,
                       help="For classifier-free sampling - specifies the s parameter, as defined in the paper.")
