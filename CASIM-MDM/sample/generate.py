...
def main():
    ...
    if args.save_attn_value:
        all_attention_values = np.stack(all_attention_values, axis=0)[:total_num_samples]
        all_attention_masks = np.stack(all_attention_masks, axis=0)[:total_num_samples]
    ...
    if args.save_attn_value:
        np.save(npy_path.replace('.npy', '_attn.npy'), {'attn_values': all_attention_values, 'attn_masks': all_attention_masks})
